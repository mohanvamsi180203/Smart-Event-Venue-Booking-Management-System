        ...
        <main class="dashboard-main">
            ...
            <div class="events-section">
                <div class="section-header">
                    <h2>All My Events</h2>
                    <a href="<%= request.getContextPath() %>/OrganizerServlet?action=dashboard" class="btn-add-event">
                        + Add New Event
                    </a>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    ...
                                    <a href="<%= request.getContextPath() %>/OrganizerServlet?action=deleteEvent&id=<%= event.getId() %>" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this event?')">Delete</a>
                                </div>
                            </td>
                        </tr>
                        <% } %>
                ...
                <div class="no-events">
                    ...
                    <a href="<%= request.getContextPath() %>/OrganizerServlet?action=dashboard" class="btn-add-event" style="margin-top: 16px; display: inline-block;">
                        + Add New Event
                    </a>
                </div>
                <% } %>
